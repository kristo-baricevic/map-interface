...
if (isProduction) {
    ...
    app.get("*", (_req, res) => {
        ...
        res.send(`<!DOCTYPE html><html><body><p>Dev server: use the <strong>Vite</strong> app at <a href="http://localhost:5173">http://localhost:5173</a> (API here is on :${PORT}).</p></body></html>`);
    });
}
app.listen(PORT, () => {
